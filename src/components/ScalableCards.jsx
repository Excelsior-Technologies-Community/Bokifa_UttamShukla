...
const ScalableCards = () => {
    return (
        <>
            <div className='font-lora flex flex-col px-5  md:flex-row justify-between items-center gap-10 md:px-4'>
                <div className="h-[180px] w-[300px] sm:h-[280px] sm:w-[500px] rounded-2xl overflow-hidden relative">
                    <div
                    ...
                    <div className='z-20 absolute top-12 right-8'>
                        ...
                        <h2 className='text-white text:2xl  sm:text-3xl md:text-2xl lg:text-4xl uppercase font-semibold'>collect <br />
                            Shop</h2>
                        <button className='mt-3 px-7 py-1 sm:py-3 bg-white rounded-full'>shop now</button>
                    </div>
                </div>
                ...
                <div className="h-[180px] w-[300px] sm:h-[280px] sm:w-[500px] rounded-2xl overflow-hidden relative">
                    ...
                    <div className='z-20 absolute top-12 right-8'>
                        ...
                        <h2 className='text-white text:2xl  sm:text-3xl md:text-2xl lg:text-4xl uppercase font-semibold'>The Truth <br />
                            Lies Here</h2>
                        <button className='mt-3 px-7 py-1 sm:py-3 bg-white rounded-full'>shop now</button>
                    </div>
                </div>
                ...
                <div className="h-[180px] w-[300px] sm:h-[280px] sm:w-[500px] rounded-2xl overflow-hidden relative">
                    ...
                    <div className='z-20 absolute top-12 right-8'>
                        ...
                        <h2 className='text-white text:2xl  sm:text-3xl md:text-2xl lg:text-4xl uppercase font-semibold'>Woman in <br />
                            the Water</h2>
                        <button className='mt-3 px-7 py-1 sm:py-3 bg-white rounded-full'>shop now</button>
                    </div>
                </div>
