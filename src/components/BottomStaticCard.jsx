        ...
        <>
            <div className='font-lora p-5'>
                ...
                <div className='flex gap-3'>
                    <div className="w-1/4 group border rounded-xl p-3 text-center overflow-hidden">
                        <div className=" overflow-hidden  rounded-lg">
                            <img
                                ...
                                alt=""
                                className="h-[62vh] w-[30vw] object-cover"
                            />
                        </div>
                     ...
                     <div className="w-1/4 group border rounded-xl p-3 text-center overflow-hidden">
                        <div className=" overflow-hidden  rounded-lg">
                            <img
                                src="https://ap-bokifa.myshopify.com/cdn/shop/files/bo_pro_25.jpg?v=1728615733&width=520"
                                alt=""
                                className="h-[62vh] w-[30vw] object-cover"
                            />
                        </div>
