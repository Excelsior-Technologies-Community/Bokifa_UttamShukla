                        ...
                        {productsData.map((items) => (
                            <SwiperSlide key={items.id}>
                                <div className="h-auto w-auto text-center group hover:border-2 p-2 rounded-xl">
                                    ...
                                    <button className="text-white bg-green-800 px-14 py-2 rounded-full sm:hidden group-hover:block transition duration-300 ease-in-out">
                                        Add to cart
                                    </button>
                                </div>
                            </SwiperSlide>
                            ...
                            return (
                                <SwiperSlide>
                                    <div className='h-auto w-auto text-center group hover:border-2 p-2 rounded-xl' key={items.id}>
                                        ...
                                        <h3 className='text-green-800 font-bold text-xl'>{items.price}</h3>
                                        <button className='text-white bg-green-800 px-14 py-2 rounded-full sm:hidden group-hover:block transition duration-300 ease-in-out'>Add to cart</button>
                                    </div>
                                </SwiperSlide>
                            )
                        })}
