            ...
            <div className="font-lora">
                ...
                <div className='flex'>
                    <div className='w-1/2 p-10'>
                        <img className='object-cover object-center w-full' src="https://ap-bokifa.myshopify.com/cdn/shop/files/bo_pro_26.jpg?v=1728615762&width=800" alt="" />
                    ...
                    <div className='w-1/2 py-10 px-4'>
                        <h1 className='text-5xl font-light'>A Prayer for Owen Meany</h1>
                        ...
                        <div className='flex items-center '>
                            <h1 className='text-green-700 text-4xl mt-3'>$29.95</h1>
                        ...
                        <div className="flex space-x-4 mt-6">
                            <a href="#" className="bg-blue-800 text-white rounded-full px-3 py-2 flex items-center justify-center">
                                <i className="ri-facebook-fill text-xl"></i>
                            </a>
                            <a href="#" className="bg-blue-400 text-white rounded-full px-3 py-2 flex items-center justify-center">
                                <i className="ri-twitter-fill text-xl"></i>
                            </a>
                            <a href="#" className="bg-red-600 text-white rounded-full px-3 py-2 flex items-center justify-center">
                                <i className="ri-pinterest-fill text-xl"></i>
                            </a>
                            <a href="#" className="bg-blue-700 text-white rounded-full px-3 py-2 flex items-center justify-center">
                ...
                <div>
                    <div className='flex gap-4 justify-center py-5 border-b-2'>
                        <button className='focus:bg-green-800 focus:text-white px-4 py-2 rounded-md' onClick={() => setfocus("Dec")}>Description</button>
                        <button className='focus:bg-green-800 focus:text-white px-4 py-2 rounded-md' onClick={() => setfocus("Add Info")}>Additional information</button>
                        <button className='focus:bg-green-800 focus:text-white px-4 py-2 rounded-md' onClick={() => setfocus("Reviews")}>Reviews</button>
                    </div>
                    <div className='px-5'>
                        ...
                        {focus === "Add Info" && <div className='w-1/3'>
                            <p className='text-gray-500 pt-10 pb-2'>
                ...
                <div className='h-auto py-10 text-center'>
                    <h1 className=' py-10'>Related Products</h1>
                    <div className='px-2'>
                        <Swiper
                            slidesPerView={4}
                            spaceBetween={20}
                        ...
                        >
                            <SwiperSlide>
                                <div className='h-auto group hover:shadow-2xl p-4'>
                                    ...
                                    <button className='bg-green-800 hidden group-hover:inline-block text-white px-16 py-2 rounded-full'>Add to Cart</button>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className='h-auto group hover:shadow-2xl p-4'>
                ...
                <div className='h-auto py-10 text-center'>
                    <h1 className=' py-10'>You may also like</h1>
                    <div className='px-2'>
                        <Swiper
                            slidesPerView={4}
                            spaceBetween={20}
